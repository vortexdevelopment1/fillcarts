...
/**
 * Submit Delivery Rider Registration Form
...
/**
 * Get Rider Status by Rider ID or Phone
 * GET /api/rider/status/:identifier
 */
...
/**
 * List All Registered Delivery Riders with Pagination (Admin View)
 * GET /api/rider/list
 */
